...
export class Contract {
      ...
      initialize: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('initialize',
                                     ...
                                     'shadow_vote.compact line 46 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      cast_vote: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('cast_vote',
                                     'argument 1 (as invoked from Typescript)',
                                     'shadow_vote.compact line 59 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
      ...
      close_election: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('close_election',
                                     'argument 1 (as invoked from Typescript)',
                                     'shadow_vote.compact line 76 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
  ...
  _vote_choice_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'boolean')) {
      __compactRuntime.typeError('vote_choice',
                                 'return value',
                                 'shadow_vote.compact line 40 char 1',
                                 'Boolean',
                                 result_0)
    }
  ...
  _cast_vote_0(context, partialProofData) {
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('shadow_vote.compact line 64 char 18: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
    ...
    if (choice_0) {
      const tmp_1 = ((t1) => {
                      if (t1 > 4294967295n) {
                        throw new __compactRuntime.CompactError('shadow_vote.compact line 67 char 17: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                      }
                      return t1;
                    })(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                 partialProofData,
      ...
      const tmp_2 = ((t1) => {
                      if (t1 > 4294967295n) {
                        throw new __compactRuntime.CompactError('shadow_vote.compact line 69 char 16: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                      }
                      return t1;
                    })(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                 partialProofData,
...
const _dummyContract = new Contract({ vote_choice: (...args) => undefined });
